...
workflow = [('train', 1)]
fp16 = None
work_dir = '/data/user_data/swa_cascade_mask_rcnn_swin_small_fpn_atss_smoothl1_casiou0.55-0.75_e12'
gpu_ids = range(0, 1)
only_swa_training = True
swa_training = True
swa_load_from = '/data/user_data/cascade_mask_rcnn_swin_small_fpn_atss_smoothl1_casiou0.55-0.75_e12/epoch_12.pth'
