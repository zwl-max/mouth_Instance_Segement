...
data = dict(
    ...
    test=dict(
        type='Mouth',
        ann_file='/data/raw_data/test/testA.json',
        img_prefix='/data/raw_data/test/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
workflow = [('train', 1)]
fp16 = None
work_dir = '/data/user_data/cascade_mask_rcnn_swin_tiny_fpn_atss_smoothl1_casiou0.55-0.75_e12'
gpu_ids = range(0, 1)
